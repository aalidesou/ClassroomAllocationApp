...
namespace ClassroomAllocationApp.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            var appDbContext = _context.Courses.Include(c => c.Department).Include(c => c.Teacher);
        ...
        public async Task<IActionResult> Create([Bind("Id,CourseCode,SubjectName,TeacherId,DepartmentId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseCode,SubjectName,TeacherId,DepartmentId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
