...
namespace ClassroomAllocationApp.Controllers
{
    public class ClassroomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RoomNumber,Capacity")] Classroom classroom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RoomNumber,Capacity")] Classroom classroom)
        {
            if (id != classroom.Id)
            {
                return NotFound();
